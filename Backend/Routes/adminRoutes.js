...
import { loginAdmin, addBlog, adminLogout , updateBlog ,deleteBlog, addAdmin } from '../controller/adminController.js';

const router = express.Router();

router.post('/login', loginAdmin);
router.post('/add-admin', authMiddleware.verifyToken, authMiddleware.authorizeRole("admin"), addAdmin);
